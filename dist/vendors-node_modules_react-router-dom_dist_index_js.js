"use strict";
(globalThis["webpackChunk_ugandaemr_esm_patient_queues_app"] = globalThis["webpackChunk_ugandaemr_esm_patient_queues_app"] || []).push([["vendors-node_modules_react-router-dom_dist_index_js"],{
...
function getUrlBasedHistory(getLocation, createHref, validateLocation, options) {
    ...
    function push(to, state) {
        ...
        try {
            ...
            if (_instanceof(error, DOMException) && error.name === "DataCloneError") {
                throw error;
            }
 ...
 */ function explodeOptionalSegments(path) {
    ...
    var _segments = _to_array(segments), first = _segments[0], rest = _segments.slice(1);
    ...
    var result = [];
    (_result = result).push.apply(_result, _to_consumable_array(restExploded.map(function(subpath) {
    ...
    if (isOptional) {
        var _result1;
        (_result1 = result).push.apply(_result1, _to_consumable_array(restExploded));
    }
 ...
 */ function matchPath(pattern, pathname) {
    ...
    var _compilePath = _sliced_to_array(compilePath(pattern.path, pattern.caseSensitive, pattern.end), 2), matcher = _compilePath[0], compiledParams = _compilePath[1];
...
var DataWithResponseInit = function DataWithResponseInit(data, init) {
    "use strict";
    _class_call_check(this, DataWithResponseInit);
 ...
 */ var ErrorResponseImpl = function ErrorResponseImpl(status, statusText, data, internal) {
    "use strict";
    _class_call_check(this, ErrorResponseImpl);
    if (internal === void 0) {
        internal = false;
    }
    this.status = status;
...
var validRequestMethodsArr = [
    "get"
].concat(_to_consumable_array(validMutationMethodsArr));
 ...
 */ function createRouter(init) {
    ...
    function updateState(newState, opts) {
        ...
        _to_consumable_array(subscribers).forEach(function(subscriber) {
                ...
                switch(_state.label){
                    ...
                    case 2:
                        ...
                        if (actionResult.pendingActionResult) {
                            _actionResult_pendingActionResult = _sliced_to_array(actionResult.pendingActionResult, 2), routeId = _actionResult_pendingActionResult[0], result = _actionResult_pendingActionResult[1];
                            if (isErrorResult(result) && isRouteErrorResponse(result.error) && result.error.status === 404) {
                                pendingNavigationController = null;
                                completeNavigation(location, {
                                    matches: actionResult.matches,
                                    loaderData: {},
                                    errors: _define_property({}, routeId, result.error)
                                });
                                return [
                                    2
                                ];
        ...
        return _async_to_generator(function() {
            ...
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                        ...
                        if (discoverResult.type === "aborted") {
                            ...
                            return [
                                2,
                                {
                                    matches: discoverResult.partialMatches,
                                    loaderData: {},
                                    errors: _define_property({}, boundaryId, discoverResult.error)
                                }
                            ];
                        } else if (!discoverResult.matches) {
                            _handleNavigational404 = handleNavigational404(location.pathname), error = _handleNavigational404.error, notFoundMatches = _handleNavigational404.notFoundMatches, route = _handleNavigational404.route;
                    ...
                    case 2:
                        routesToUse = inFlightDataRoutes || dataRoutes;
                        _getMatchesToLoad = _sliced_to_array(getMatchesToLoad(init.history, state, matches, activeSubmission, location, future.v7_partialHydration && initialHydration === true, future.v7_skipActionErrorRevalidation, isRevalidationRequired, cancelledDeferredRoutes, cancelledFetcherLoads, deletedFetchers, fetchLoadMatches, fetchRedirectIds, routesToUse, basename, pendingActionResult), 2), matchesToLoad = _getMatchesToLoad[0], revalidatingFetchers = _getMatchesToLoad[1];
                        ...
                        if (matchesToLoad.length === 0 && revalidatingFetchers.length === 0) {
                            ...
                            completeNavigation(location, _extends({
                                ...
                                errors: pendingActionResult && isErrorResult(pendingActionResult[1]) ? _define_property({}, pendingActionResult[0], pendingActionResult[1].error) : null
    ...
    function getUpdatedActionData(pendingActionResult) {
        if (pendingActionResult && !isErrorResult(pendingActionResult[1])) {
            ...
            return _define_property({}, pendingActionResult[0], pendingActionResult[1].data);
            ...
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    ...
                    case 3:
                        ...
                        _getMatchesToLoad = _sliced_to_array(getMatchesToLoad(init.history, state, matches, submission, nextLocation, false, future.v7_skipActionErrorRevalidation, isRevalidationRequired, cancelledDeferredRoutes, cancelledFetcherLoads, deletedFetchers, fetchLoadMatches, fetchRedirectIds, routesToUse, basename, [
                            match.route.id,
                            actionResult
   ...
   */ function startRedirectNavigation(request, redirect, isNavigation, _temp2) {
            ...
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    ...
                    case 6:
                        ...
                        _step_value = _sliced_to_array(_step.value, 2), routeId = _step_value[0], result = _step_value[1];
                                ...
                                return _ts_generator(this, function(_state) {
                                    switch(_state.label){
                                        ...
                                        case 1:
                                            ...
                                            return [
                                                2,
                                                _define_property({}, f.key, result)
                                            ];
                                        case 2:
                                            return [
                                                2,
                                                Promise.resolve(_define_property({}, f.key, {
                                                    type: ResultType.error,
    ...
    function interruptActiveLoads() {
        ...
        isRevalidationRequired = true;
        (_cancelledDeferredRoutes = cancelledDeferredRoutes).push.apply(_cancelledDeferredRoutes, _to_consumable_array(cancelActiveDeferreds()));
    ...
    function shouldBlockNavigation(_ref2) {
        ...
        var _entries_ = _sliced_to_array(entries[entries.length - 1], 2), blockerKey = _entries_[0], blockerFunction = _entries_[1];
                                ...
                                switch(_state.label){
                                    ...
                                    case 4:
                                        ...
                                        if (isNonHMR && !signal.aborted) {
                                            dataRoutes = _to_consumable_array(dataRoutes);
                                        }
                                        return [
                                            7
                                        ];
                        ...
                        if (!isValidMethod(method) && method !== "HEAD") {
                            ...
                            return [
                                2,
                                {
                                    ...
                                    loaderData: {},
                                    actionData: null,
                                    errors: _define_property({}, route1.id, error1),
                    ...
                    case 6:
                        ...
                        return [
                            ...
                            _extends({}, context1, {
                                ...
                                actionHeaders: result.headers ? _define_property({}, actionMatch.route.id, result.headers) : {}
                            })
                        ];
                }
            });
                            ...
                            return [
                                2,
                                {
                                    ...
                                    loaderData: matches.reduce(function(acc, m) {
                                        return Object.assign(acc, _define_property({}, m.route.id, null));
                                    }, {}),
                                    errors: pendingActionResult && isErrorResult(pendingActionResult[1]) ? _define_property({}, pendingActionResult[0], pendingActionResult[1].error) : null,
                                    statusCode: 200,
                                    loaderHeaders: {},
...
function normalizeNavigateOptions(normalizeFormMethod, isFetcher, path, opts) {
    ...
    if (opts.body !== undefined) {
        if (opts.formEncType === "text/plain") {
            ...
            var text = typeof opts.body === "string" ? opts.body : _instanceof(opts.body, FormData) || _instanceof(opts.body, URLSearchParams) ? // https://html.spec.whatwg.org/multipage/form-control-infrastructure.html#plain-text-form-data
            Array.from(opts.body.entries()).reduce(function(acc, _ref3) {
                var _$_ref3 = _sliced_to_array(_ref3, 2), name = _$_ref3[0], value = _$_ref3[1];
    ...
    } else if (_instanceof(opts.body, FormData)) {
        searchParams = convertFormDataToSearchParams(opts.body);
        formData = opts.body;
    } else if (_instanceof(opts.body, URLSearchParams)) {
...
function patchRoutesImpl(routeId, children, routesToUse, manifest, mapRouteProperties) {
    ...
    (_childrenToPatch = childrenToPatch).push.apply(_childrenToPatch, _to_consumable_array(newRoutes));
}
                ...
                case 1:
                    ...
                    return [
                        ...
                        results.reduce(function(acc, result, i) {
                            return Object.assign(acc, _define_property({}, matchesToLoad[i].route.id, result));
                        }, {})
                    ];
            }
        });
            ...
            switch(_state.label){
                case 0:
                    ...
                    dsMatches = matches.map(function(match, i) {
                        ...
                        var resolve = function(handlerOverride) {
                            return _async_to_generator(function() {
                                return _ts_generator(this, function(_state) {
                ...
                case 0:
                    runHandler = function(handler) {
                        ...
                        var actualHandler = function(ctx) {
                            ...
                            ].concat(_to_consumable_array(ctx !== undefined ? [
                                ctx
                            ] : [])));
                        };
                ...
                case 10:
                    if (type === ResultType.error) {
                        if (isDataWithResponseInit(result)) {
                            ;
                            if (_instanceof(result.data, Error)) {
                                ;
                                return [
                                    2,
                                    {
...
function processRouteLoaderData(matches, results, pendingActionResult, activeDeferreds, skipLoaderErrorBubbling) {
    ...
    if (pendingError !== undefined && pendingActionResult) {
        errors = _define_property({}, pendingActionResult[0], pendingError);
...
function getActionDataForCommit(pendingActionResult) {
    ...
    return isErrorResult(pendingActionResult[1]) ? {
        ...
        actionData: _define_property({}, pendingActionResult[0], pendingActionResult[1].data)
    };
}
...
function findRedirect(results) {
    ...
    for(var i = entries.length - 1; i >= 0; i--){
        var _entries_i = _sliced_to_array(entries[i], 2), key = _entries_i[0], result = _entries_i[1];
        if (isRedirectResult(result)) {
            return {
                key: key,
                result: result
...
function isDataStrategyResult(result) {
    return result != null && (typeof result === "undefined" ? "undefined" : _type_of(result)) === "object" && "type" in result && "result" in result && (result.type === ResultType.data || result.type === ResultType.error);
}
...
function isDataWithResponseInit(value) {
    return (typeof value === "undefined" ? "undefined" : _type_of(value)) === "object" && value != null && "type" in value && "data" in value && "init" in value && value.type === "DataWithResponseInit";
}
function isDeferredData(value) {
    var deferred = value;
    return deferred && (typeof deferred === "undefined" ? "undefined" : _type_of(deferred)) === "object" && _type_of(deferred.data) === "object" && typeof deferred.subscribe === "function" && typeof deferred.cancel === "function" && typeof deferred.resolveData === "function";
}
                ...
                case 0:
                    _loop = function(index) {
                        ...
                        return _ts_generator(this, function(_state) {
                            switch(_state.label){
                                case 0:
                                    _entries_index = _sliced_to_array(entries[index], 2), routeId = _entries_index[0], result = _entries_index[1];
 ...
 */ function RouterProvider(_ref) {
    ...
    var _React_useState = _sliced_to_array(react__WEBPACK_IMPORTED_MODULE_0__.useState(router.state), 2), state = _React_useState[0], setStateImpl = _React_useState[1];
    var _React_useState1 = _sliced_to_array(react__WEBPACK_IMPORTED_MODULE_0__.useState(), 2), pendingState = _React_useState1[0], setPendingState = _React_useState1[1];
    var _React_useState2 = _sliced_to_array(react__WEBPACK_IMPORTED_MODULE_0__.useState({
        isTransitioning: false
    }), 2), vtContext = _React_useState2[0], setVtContext = _React_useState2[1];
    var _React_useState3 = _sliced_to_array(react__WEBPACK_IMPORTED_MODULE_0__.useState(), 2), renderDfd = _React_useState3[0], setRenderDfd = _React_useState3[1];
    var _React_useState4 = _sliced_to_array(react__WEBPACK_IMPORTED_MODULE_0__.useState(), 2), transition = _React_useState4[0], setTransition = _React_useState4[1];
    var _React_useState5 = _sliced_to_array(react__WEBPACK_IMPORTED_MODULE_0__.useState(), 2), interruption = _React_useState5[0], setInterruption = _React_useState5[1];
    ...
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(function() {
        if (renderDfd && pendingState && router.window) {
            ...
            var transition = router.window.document.startViewTransition(function() {
                return _async_to_generator(function() {
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
    ...
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(function() {
        return (0,react_router__WEBPACK_IMPORTED_MODULE_2__.UNSAFE_logV6DeprecationWarnings)(future, router.future);
    }, [
        future,
        router.future
    ]);
 ...
 */ function BrowserRouter(_ref4) {
    ...
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(function() {
        return (0,react_router__WEBPACK_IMPORTED_MODULE_2__.UNSAFE_logV6DeprecationWarnings)(future);
    }, [
        future
    ]);
 ...
 */ function useFetcher(_temp3) {
    ...
    var _React_useState = _sliced_to_array(react__WEBPACK_IMPORTED_MODULE_0__.useState(key || defaultKey), 2), fetcherKey = _React_useState[0], setFetcherKey = _React_useState[1];
...
function DefaultErrorComponent() {
    ...
    var message = (0,_remix_run_router__WEBPACK_IMPORTED_MODULE_1__.isRouteErrorResponse)(error) ? error.status + " " + error.statusText : _instanceof(error, Error) ? error.message : JSON.stringify(error);
 ...
 */ function useBlocker(shouldBlock) {
    ...
    var _React_useState = _sliced_to_array(react__WEBPACK_IMPORTED_MODULE_0__.useState(""), 2), blockerKey = _React_useState[0], setBlockerKey = _React_useState[1];
    ...
    _create_class(AwaitErrorBoundary, [
        ...
        },
        {
            ...
            value: function render() {
                ...
                if (status === AwaitRenderStatus.error && _instanceof(promise._error, _remix_run_router__WEBPACK_IMPORTED_MODULE_1__.AbortedDeferredError)) {
